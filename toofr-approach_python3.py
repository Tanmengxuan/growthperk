...
if __name__=='__main__':
    ...
    print(xray_linkedin_url_bing("Business Development Manager","","Boston"))
    search(xray_linkedin_url_bing("Business Development Manager","","Boston"), "outputfile-BDM_Boston.txt")
